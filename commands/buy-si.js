...
module.exports = {
    ...
    var users = JSON.parse(fs.readFileSync("./users.json", "utf8"));
        var shop = JSON.parse(fs.readFileSync("./shop-il.json", "utf8"))["array"];
        ...
        function buy(id) {
            ...
            if(users[message.author.id].shekels >= shop[id].cost) {
                ...
                users[message.author.id].shekels -= shop[id].cost
            ...
            let buyMess = new Discord.MessageEmbed()
                ...
                .setDescription(`Вы купили \`${shop[id].name}\` за \`${shop[id].cost}\`₪`)
                .setColor('RANDOM')
